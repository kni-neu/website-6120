...
Hello everyone, happy new year, and welcome to CS 6120: Natural Language Processing for Spring 2026!

We’re living in an extraordinary moment for language technology. Over the past few years, large language models (LLMs) like GPT-5, Claude, Gemini, and Llama have gone from research curiosities to tools that millions of people use daily. They write, translate, summarize, code, and even reason in ways that feel startlingly human.

But how do they actually work? And equally important: What do we, as NLP practitioners, need to understand in order to push the field forward, build responsibly, and use these tools well?
...
This week we'll get oriented. This class uses this website, Gradescope, Google slides, Colab, and not Canvas. Additionally, we'll be setting up our Google Cloud Platform infrastructure. I'll provide you with an access code for some credits to use for the semester.

For the first class,

* Lecture 1: From Rules to Transformers — the arc of NLP research leading to LLMs.
...
After the first class, I would advise you to do the following.
